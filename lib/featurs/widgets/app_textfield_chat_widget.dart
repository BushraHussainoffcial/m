...
class AppTextChatFieldWidget extends StatefulWidget {
  ...
  @override
  State<AppTextChatFieldWidget> createState() => _AppTextChatFieldWidgetState();
}

class _AppTextChatFieldWidgetState extends State<AppTextChatFieldWidget> {
  void showPassword() {
    setState(() {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: ColorsManager.chatTextFiledColor.withOpacity(.059),
